...
CRYPTO_TICKERS = [
    # --- BLUECHIPS & TOP LAYER 1s ---
    "BTC-USD", "ETH-USD", "BNB-USD", "SOL-USD", "XRP-USD", "ADA-USD", "DOT-USD", "LTC-USD", "BCH-USD", "XLM-USD",
    
    # --- NEW GENERATION L1 / HIGH PERFORMANCE ---
    "SUI-USD", "APT21794-USD", "NEAR-USD", "TON11419-USD", "KAS-USD", "INJ-USD", "SEI-USD", "MINA-USD", "ATOM-USD",
    "TIA22861-USD", "DYM-USD", "SAGA32859-USD", "MONAD-USD", "MOVE-USD", "HBAR-USD", "ALGO-USD", "ICP-USD", "ALEO-USD",

    # --- HYPERLIQUID & DEFI MAJORS (HOT!) ---
    "HYPE-USD", "AAVE-USD", "MKR-USD", "UNI7083-USD", "LINK-USD", "ONDO-USD", "JUP29210-USD", "ENA-USD", "CRV-USD", 
    "PENDLE-USD", "RAY-USD", "JTO-USD", "PYTH-USD", "COMP5692-USD", "SNX-USD", "DYDX-USD", "GMX-USD", "1INCH-USD", 
    "SUSHI-USD", "CAKE-USD", "BAL-USD", "YFI-USD", "KNC-USD", "RUNE-USD", "OSMO-USD", "TRB-USD", "UMA-USD", "DIA-USD",

    # --- ETHEREUM L2s & SCALING ---
    "MATIC-USD", "ARB11841-USD", "OP-USD", "STRK22691-USD", "MNT-USD", "ZK-USD", "ZKL-USD", "IMX10603-USD", "METIS-USD", 
    "LRC-USD", "SKL-USD", "BOBA-USD", "MASK-USD", "ZRO-USD", "MANTA-USD", "ALT-USD", "AEVO-USD", "TAIKO-USD", "SCR-USD",

    # --- AI & DEPIN (THE BIG NARRATIVE) ---
    "FET-USD", "TAO22974-USD", "RNDR-USD", "AKT-USD", "WLD-USD", "GRT6719-USD", "THETA-USD", "HNT-USD", "IOTX-USD", 
    "IO29796-USD", "ATH-USD", "PRIME-USD", "NMT-USD", "NOS-USD", "GLM-USD", "AIOZ-USD", "ARKM-USD", "LPT-USD",
    "API3-USD", "NMR-USD", "CTXC-USD", "NUM-USD", "STORJ-USD", "ANKR-USD", "SC-USD", "FIL-USD", "AR-USD",

    # --- AI AGENTS & VIRTUAL PROTOCOLS (TERBARU & RAME) ---
    "VIRTUAL-USD", "AI16Z-USD", "GOAT-USD", "ACT-USD", "AIXBT-USD", "GRIFFAIN-USD", "ZEREBRO-USD", "FARTCOIN-USD",

    # --- MEME COINS (OG & SOLANA/ETH META) ---
    "DOGE-USD", "SHIB-USD", "PEPE24478-USD", "WIF-USD", "BONK-USD", "FLOKI-USD", "BRETT29743-USD", "POPCAT-USD", 
    "NEIRO-USD", "PNUT-USD", "MOODENG-USD", "SUNDOG-USD", "TURBO24911-USD", "MEME28301-USD", "MEW-USD", "DEGEN-USD", 
    "WEN-USD", "PUPS-USD", "BOME-USD", "SLERF-USD", "MYRO-USD", "MOG-USD", "SPX-USD", "GIGA-USD", "FWOG-USD",

    # --- MODULAR, LIQUID STAKING & RESTAKING (LST/LRT) ---
    "LDO-USD", "RPL-USD", "ENS-USD", "ETHFI-USD", "REZ-USD", "SWELL-USD", "EIGEN-USD", "BB31254-USD",
    "WETH-USD", "CBETH-USD", "STETH-USD", "RETH-USD", "ETHX-USD", "FRAX-USD", "FXS-USD", "CVX-USD",

    # --- GAMING, METAVERSE & NFT ---
    "GALA-USD", "AXS-USD", "SAND-USD", "MANA-USD", "ENJ-USD", "MAGIC-USD", "BIGTIME-USD", "BEAM-USD", "YGG-USD", 
    "PIXEL-USD", "MAVIA-USD", "XAI28200-USD", "APE18876-USD", "BLUR-USD", "LOOKS-USD", "SUPER8290-USD", "ALICE-USD", 
    "SLP-USD", "ILV-USD", "UFO-USD", "VRA-USD", "CHZ-USD", "WAX-USD",

    # --- PRIVACY & OLDER ALTS ---
    "XMR-USD", "ZEC-USD", "DASH-USD", "FIRO-USD", "FTM-USD", "EGLD-USD", "FLOW-USD", "KAVA-USD", "ROSE-USD", 
    "ONE-USD", "IOTA-USD", "ZIL-USD", "NEO-USD", "WAVES-USD", "ICX-USD", "QTUM-USD", "ONT-USD", "CKB-USD", 
    "XTZ-USD", "EOS-USD", "BAND-USD", "SCRT-USD", "DERO-USD", "BTT-USD", "HOT-USD", "CTSI-USD", "AUDIO-USD", 

    # --- CEX TOKENS & RWA ---
    "OKB-USD", "KCS-USD", "BGB-USD", "GT-USD", "CRO-USD", "FTT-USD", "LEO-USD", "MX-USD", "JASMY-USD", "POLYX-USD",
    "TRX-USD", "OM-USD", "PROPS-USD", "AVA-USD",

    # --- STABLECOINS & FIAT-BACKED ---
    "USDT-USD", "USDC-USD", "DAI-USD", "USDS33039-USD", "FDUSD-USD", "PYUSD-USD",
]
